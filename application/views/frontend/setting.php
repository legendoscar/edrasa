...
<<<<<<< HEAD
		...
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="fas fa-globe"></i> Exam Settings </h4>
			</header>
					<?php echo form_open('frontend/setting/saveExamcolumn' . get_request_url(), array('class' => 'form-horizontal form-bordered frm-submit-data')); ?>
			<!-- <form action="/frontend/setting/saveExamcolumn" method="post" class="form-horizontal form-bordered frm-submit-data"> -->
				<div class="panel-body">
					<div class="form-group mt-md">
						<label class="col-md-3 control-label">Exam Columes <span class="required">*</span></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="column_name"
								value="<?php echo set_value('column_name', $exam_columns['column_name']); ?>" />
=======
							</div>
						</div>
					</div>
		...
		if (!empty($branch_id)) : ?>
			...
			<section class="panel">
				...
				<div class="panel-body">
					<div class="form-group mt-md">
						<label class="col-md-3 control-label">Exam Columns (Comma separated)<span class="required">*</span></label>
						<div class="col-md-6">
							<input type="text" class="form-control" name="column_name" value="<?php echo set_value('column_name', $exam_columns['column_name']); ?>" />
>>>>>>> ef448f145b85b6221049e851fdd51b0d5c32a854
							<span class="error"><?php echo form_error('column_name'); ?></span>
						</div>
					</div>
				</div>
...
<<<<<<< HEAD
		...
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="fas fa-globe"></i>
					<?php echo translate('website') . " " . translate('settings'); ?></h4>
			</header>
			...
			<div class="panel-body">
				<div class="form-group mt-md">
					<label class="col-md-3 control-label"><?php echo translate('cms') . " " . translate('title'); ?>
						<span class="required">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="application_title"
							value="<?php echo set_value('application_title', $setting['application_title']); ?>" />
						<span class="error"><?php echo form_error('application_title'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('cms') . " " . translate('url_alias'); ?>
						<span class="required">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="url_alias"
							value="<?php echo set_value('url_alias', $setting['url_alias']); ?>" />
						<span class="error"><?php echo form_error('url_alias'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('cms_frontend'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<div class="radio-custom radio-success radio-inline mb-xs">
							<input type="radio" value="1" name="cms_frontend_status"
								<?= ($setting['cms_active'] == 1 ? 'checked' : '') ?> id="sstatus_1">
							<label for="sstatus_1"><?= translate('enabled') ?></label>
						</div>

						<div class="radio-custom radio-danger radio-inline">
							<input type="radio" value="0" name="cms_frontend_status"
								<?= ($setting['cms_active'] == 0 ? 'checked' : '') ?> id="sstatus_2">
							<label for="sstatus_2"><?= translate('disabled') ?></label>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('online_admission'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<div class="radio-custom radio-success radio-inline mb-xs">
							<input type="radio" value="1" <?= ($setting['online_admission'] == 1 ? 'checked' : '') ?>
								name="online_admission" id="astatus_1">
							<label for="astatus_1"><?= translate('enabled') ?></label>
						</div>

						<div class="radio-custom radio-danger radio-inline">
							<input type="radio" value="0" <?= ($setting['online_admission'] == 0 ? 'checked' : '') ?>
								name="online_admission" id="astatus_2">
							<label for="astatus_2"><?= translate('disabled') ?></label>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('receive_email_to'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="receive_email_to"
							value="<?php echo set_value('receive_email_to', $setting['receive_contact_email']); ?>" />
						<span class="error"><?php echo form_error('receive_email_to'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('captcha_status'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<?php
=======
...
<<<<<<< HEAD
				...
				<div class="form-group" id="recaptcha_site_key">
					<label class="col-md-3 control-label"><?php echo translate('recaptcha_site_key'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="recaptcha_site_key"
							value="<?php echo set_value('recaptcha_site_key', $setting['recaptcha_site_key']); ?>" />
						<span class="error"><?php echo form_error('recaptcha_site_key'); ?></span>
					</div>
				</div>
				<div class="form-group" id="recaptcha_secret_key">
					<label class="col-md-3 control-label"><?php echo translate('recaptcha_secret_key'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="recaptcha_secret_key"
							value="<?php echo set_value('recaptcha_secret_key', $setting['recaptcha_secret_key']); ?>" />
						<span class="error"><?php echo form_error('recaptcha_secret_key'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('working_hours'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<textarea class="form-control" id="working_hours" name="working_hours" placeholder=""
							rows="3"><?php echo set_value('working_hours', $setting['working_hours']); ?></textarea>
						<span class="error"><?php echo form_error('working_hours'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('logo'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<input type="file" name="logo" class="dropify" data-height="90"
							data-allowed-file-extensions="png jpg jpeg"
							data-default-file="<?php echo  $setting['logo']; ?>" />
						<span class="error"><?php echo form_error('logo'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('fav_icon'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<input type="file" name="fav_icon" class="dropify" data-height="90"
							data-allowed-file-extensions="png ico"
							data-default-file="<?php echo  $setting['fav_icon']; ?>" />
						<span class="error"><?php echo form_error('fav_icon'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('address'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<textarea class="form-control" id="address" name="address" placeholder=""
							rows="3"><?php echo set_value('address', $setting['address']); ?></textarea>
						<span class="error"><?php echo form_error('address'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('theme'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						...
						<ul class="list-unstyled thememenu-sy">
							<li>
								<div class="theme-box">
									<label>
										<input name="theme_color" value="blue" type="radio"
											<?= ($setting['theme'] == 'blue' ? 'checked' : ''); ?>>
										<div class="theme-img">
							...
							<li>
								<div class="theme-box">
									<label>
										<input name="theme_color" value="red" type="radio"
											<?= ($setting['theme'] == 'red' ? 'checked' : ''); ?>>
										<div class="theme-img">
				...
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('mobile_no'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="mobile_no"
							value="<?php echo set_value('mobile_no', $setting['mobile_no']); ?>" />
						<span class="error"><?php echo form_error('mobile_no'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('email'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="email"
							value="<?php echo set_value('email', $setting['email']); ?>" />
						<span class="error"><?php echo form_error('email'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('fax'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<input type="text" class="form-control" name="fax"
							value="<?php echo set_value('fax', $setting['fax']); ?>" />
						<span class="error"><?php echo form_error('fax'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('footer_about_text'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<textarea class="form-control" id="footer_about_text" name="footer_about_text" placeholder=""
							rows="3"><?php echo set_value('footer_about_text', $setting['footer_about_text']); ?></textarea>
						<span class="error"><?php echo form_error('footer_about_text'); ?></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><?php echo translate('copyright_text'); ?> <span
							class="required">*</span></label>
					<div class="col-md-6">
						<textarea class="form-control" id="copyright_text" name="copyright_text" placeholder=""
							rows="3"><?php echo set_value('copyright_text', $setting['copyright_text']); ?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="facebook_url"
							value="<?php echo set_value('facebook_url', $setting['facebook_url']); ?>" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="twitter_url"
							value="<?php echo set_value('twitter_url', $setting['twitter_url']); ?>" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="youtube_url"
							value="<?php echo set_value('youtube_url', $setting['youtube_url']); ?>" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="google_plus"
							value="<?php echo set_value('google_plus', $setting['google_plus']); ?>" />
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="linkedin_url"
							value="<?php echo set_value('linkedin_url', $setting['linkedin_url']); ?>" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="pinterest_url"
							value="<?php echo set_value('pinterest_url', $setting['pinterest_url']); ?>" />
					</div>
				</div>
				<div class="form-group <?php if (form_error('instagram_url')) echo 'has-error'; ?>">
					...
					<div class="col-md-6 mb-md">
						<input type="text" class="form-control" name="instagram_url"
							value="<?php echo set_value('instagram_url', $setting['instagram_url']); ?>" />
					</div>
				</div>
			</div>
			<div class="panel-footer">
...
=======
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="file" name="logo" class="dropify" data-height="90" data-allowed-file-extensions="png jpg jpeg" data-default-file="<?php echo  $setting['logo']; ?>" />
							<span class="error"><?php echo form_error('logo'); ?></span>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="file" name="fav_icon" class="dropify" data-height="90" data-allowed-file-extensions="png ico" data-default-file="<?php echo  $setting['fav_icon']; ?>" />
							<span class="error"><?php echo form_error('fav_icon'); ?></span>
						</div>
					</div>
					<div class="form-group">
...
<<<<<<< HEAD
	...
	?
	php
	if ($setting['captcha_status'] == "enable") {
		?
		>
