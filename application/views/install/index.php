...
<body>
    <div class="container pmx">
            ...
            <div class="tabs-custom">
                <ul class="nav nav-tabs txt-font-et">
                    <li class="<?= ($step == 1 ? 'active' : ''); ?>">
                        <a href="javascript:void(0);"><i class="fas fa-parachute-box"></i>
                            <h5>Requirements</h5>
                        </a>
                    </li>
                    <li class="<?= ($step == 2 ? 'active' : ''); ?>">
                        <a href="javascript:void(0);"><i class="fas fa-laptop-code"></i>
                            <h5>Purchase Code</h5>
                        </a>
                    </li>
                    <li class="<?= ($step == 3 ? 'active' : ''); ?>">
                        <a href="javascript:void(0);"><i class="fas fa-database"></i>
                            <h5>Database</h5>
                        </a>
                    </li>
                    <li class="<?= ($step == 4 ? 'active' : ''); ?>">
                        <a href="javascript:void(0);"><i class="fas fa-server"></i>
                            <h5>Install</h5>
                        </a>
                    </li>
                    <li class="<?= ($step == 5 ? 'active' : ''); ?>">
                        <a href="javascript:void(0);"><i class="fas fa-check"></i>
                            <h5>Completed</h5>
                        </a>
                    </li>
                </ul>
        ...
        <center> 2020 © All Rights Reserved - <a href="about:blank">LosinSMS</a></center>
    </div>
