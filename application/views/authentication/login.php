    ...
    <div class="auth-main">
        <div class="container">
            <div class="slideIn">
                ...
                <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding fitxt-center hidden-sm hidden-xs">
                ...
                <div class="col-lg-6 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
                    <div class="sign-area">
                        <div class="sign-hader">
                            <img src="<?php echo $global_config['logo_file']; ?>" height="54" alt="">
