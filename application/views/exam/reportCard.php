...
if (count($student_array)) {
	foreach ($student_array as $sc => $studentID) {
		...
		$branch_config = $this->db->get_where('front_cms_setting', array('branch_id' => $getExam['branch_id']))->row_array();
?>
		<div class="mark-container">
			<table border="0" style="margin-top: 20px; height: 100px;">
				<tbody>
					<tr>
						<td style="width:40%;vertical-align: top;"><img style="width:200px;" src="<?php echo $branch_config['logo'] ?? base_url('uploads/app_image/report-card-logo.png') ?>"></td>
						<td style="width:60%;vertical-align: top;">
							<table align="right" class="table-head text-right">
								<tbody>
									...
									<tr>
										<th style="font-size: 14px; padding-top: 4px;" class="text-right">Academic Session : <?= $schoolYear ?></th>
									</tr>
									<tr>
