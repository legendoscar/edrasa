...
<<<<<<< HEAD
						...
						<tbody>
							...
							<tr>
								<input type="hidden" name="mark[<?= $key ?>][student_id]"
								...
								<td>
									<div class="checkbox-replace">
										<label class="i-checks">
											<input type="checkbox" name="mark[<?= $key ?>][absent]"
												<?= ($row['get_abs'] == 'on' ? 'checked' : ''); ?>>
											<i></i>
										</label>
									</div>
								</td>
								...
								<td class="min-w-sm">
									...
									<div class="form-group">
										<input type="text" class="form-control" autocomplete="off"
											name="column[<?= $key ?>][<?= trim($column); ?>]"
											value="<?= json_decode($marks[$key]['mark'], true)[trim($column)] ?>"
											required>
											...
											?>
												...
												?>
													<td class="min-w-sm">
														...
														<div class="form-group">
															<input type="text" class="form-control" autocomplete="off" name="column[<?= $key ?>][<?= trim($column); ?>]" value="<?= json_decode($marks[$key]['mark'], true)[trim($column)] ?>" required>
															<span class="error"></span>
														</div>
													</td>
												<?php
